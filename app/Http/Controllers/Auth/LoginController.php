...
class LoginController extends Controller
{
 ...
 protected function login(Request $request) {
    try {
        ...
        Session::put('email', $request['email']); // Store the email in the session
        Session::put('password', Hash::make($request['password'])); // Store the hashed password in the session
