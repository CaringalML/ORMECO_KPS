...
<section id="content">
    ...
    <nav>
        ...
        <form action="{{ route('dynamic.report_list') }}" method="GET">
        ...
        <ul class="box-info">
            <li>
                <div class="input-container">
                    <form action="{{ route('add_report_list') }}" method="POST">
                        @csrf
            ...
            <li>
                        ...
                        <input placeholder="Enter report name" class="input" name="notices" type="text" required>
                        @error('notices')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="order">
                ...
                <table>
                    ...
                    <tbody>
                      @foreach($hogs as $hog)
                      <tr>
                        <td>{{ $hog->department_id }}</td>
                        <td>{{ $hog->name }}</td>
                        <td>{{ $hog->notices }}</td>
                        <td>{{ $hog->created_at }}</td>
                        <td>
                          <a href="{{ route('hogs.edit', $hog->id) }}">
                            <i class="bx bx-edit neon-green"></i>
                          </a>
                          <button onclick="openConfirmationModal({{ $hog->id }})">
                            <i class="bx bx-trash neon-red"></i>
                          </button>
                          <form id="deleteForm-{{ $hog->id }}" action="{{ route('hogs.destroy', $hog->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
