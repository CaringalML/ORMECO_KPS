    ...
    <div class="card">
        ...
        <form action="{{ route('cats.update', $cat->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="input" name="department_id" id="department_id" value="{{ $cat->department_id }}" required>
            </div>
    
            <div class="form-group">
                <label for="notices">Report Name</label>
                <input type="text" class="input" name="notices" id="notices" value="{{ $cat->notices }}" required>
            </div>
