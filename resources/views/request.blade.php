...
<section id="content">
    ...
    <nav>
        ...
        <form action="{{ route('request.add_report') }}" method="GET">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>Realtime Request of Reports</h1>
                <ul class="breadcrumb">
                    <li>
                        <a href="{{ route('products.team') }}">Realtime Request</a>
                    </li>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <button onclick="openConfirmationModal({{ $cat->id }})">
                            <i class="bx bx-trash neon-red"></i>
                          </button>
                          <form id="deleteForm-{{ $cat->id }}" action="{{ route('cats.destroy', $cat->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
