...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{ route('hogs.update', $hog->id) }}" method="POST">
            @method('PUT')
            @csrf
    
            <div class="form-group">
                <label for="department_id">Department ID</label>
                <input type="text" class="input" name="department_id" id="department_id" value="{{ $hog->department_id }}" required>
            </div>
    
            <div class="form-group">
                <label for="notices">Report Name</label>
                <input type="text" class="input" name="notices" id="notices" value="{{ $hog->notices }}" required>
            </div>
